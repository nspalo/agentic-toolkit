...
echo ""
echo "  2. Add to your IDE workspace (alongside project repo + agentic-toolkit)"
echo ""
...
echo ""
echo "  4. Start a session and say:"
echo "     Read projects/project-code/.detected-stack.md and help me fill project-context.md"
echo ""
