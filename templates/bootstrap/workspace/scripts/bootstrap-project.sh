...
# Create directory structure (no .kiro-draft/steering — that's opt-in via make steering-*)
mkdir -p "$PROJECT_DIR"/{knowledge-base,testcases,technical-notes/jira/{tickets,epics,proposals},technical-notes/investigation,documentation/diagrams,generated-files,.kiro-draft/{hooks,skills}}

# Copy base templates from toolkit
...
echo ""
echo "Next steps:"
echo "  1. Link to your code repo (fills project-context.md automatically):"
echo "     make project-link name=$PROJECT_NAME repo=/path/to/your/$PROJECT_NAME"
echo ""
echo "  2. (Optional) Generate steering files for the project:"
echo "     make steering-generate project=$PROJECT_NAME"
