...
> Auto-generated by make project-link. Refine as you learn more about the project.
...
# Save repo path for other scripts (e.g., scaffold-steering.sh)
echo "$REPO_PATH" > "${PROJECT_DIR}/.repo-path"
